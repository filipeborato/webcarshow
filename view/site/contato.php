...
<html>
    ...
    <body>
        ...
        <section id="contact">
			...
			<!-- Cada script possui uma área/div especifico que ira receber o código do mapa. Cada área possui suas dimensões, no caso, esta área é de 1980x525 px -->
			<div id="map">
				<!-- COLE AQUI O CÓDIGO DO MAPA COM DIMENSÃO 1980 X 525 PX-->
			</div>
			<!-- Pronto! Agora é só enviar o arquivo desejado para o servidor através do FTP -->
        ...
        <script type="text/javascript" src="http://maps.google.com/maps/api/js?key=<?php include 'gmap.php'; echo $api_key; ?>"></script>    
